...
var AddOfferComponent = (function (_super) {
    ...
    AddOfferComponent.prototype.addOffre = function (offre) {
        var _this = this;
        this._listVen.postOffer(offre).subscribe(function (data) { return _this.o = data; }, function (error) { return _this.status = "Somethings append"; }, function () { return console.log("Done"); });
    };
